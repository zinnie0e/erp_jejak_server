...
public interface JpJejakMapper {
	...
	public List<JpJejakVO> selStartBj1(JpJejakVO params);
	public List<JpJejakVO> selStartBj2(JpJejakVO params);
	public List<JpJejakVO> selStartBj3();
	public List<JpJejakVO> selStartBj4(JpJejakVO params);
	public List<JpJejakVO> selStartBj5();
	public List<JpJejakVO> selStartBj6(JpJejakVO params);
	public List<JpJejakVO> selStartBj7();
	public List<JpJejakVO> selStartBj8();
	public List<JpJejakVO> selStartBj9(JpJejakVO params);
	public List<JpJejakVO> selStartBj10(JpJejakVO params);
	public List<JpJejakVO> selStartBj11(JpJejakVO params);
	public List<JpJejakVO> selStartBj12();
	public List<JpJejakVO> selStartBj13();
	public List<JpJejakVO> selStartBj14(JpJejakVO params);
	public List<JpJejakVO> selStartBj15();
	public List<JpJejakVO> selStartBj16(JpJejakVO params);
	public List<JpJejakVO> selStartBj17(JpJejakVO params);
	public List<JpJejakVO> selStartBj18(JpJejakVO params);
	public List<JpJejakVO> selStartBj19(JpJejakVO params);
	public List<JpJejakVO> selStartBj20();
	public List<JpJejakVO> selStartBj21(JpJejakVO params);
	public List<JpJejakVO> selStartBj22();
	public List<JpJejakVO> selStartBj23(JpJejakVO params);
	public List<JpJejakVO> selStartBj24();
	public List<JpJejakVO> selStartBj25(JpJejakVO params);
	public List<JpJejakVO> selStartBj26(JpJejakVO params);
	public List<JpJejakVO> selStartBj27(JpJejakVO params);
	public List<JpJejakVO> selStartBj28(JpJejakVO params);
	public List<JpJejakVO> selStartBj29(JpJejakVO params);
	public List<JpJejakVO> selStartBj30(JpJejakVO params);
	public int upStartBj1(JpJejakVO params);
	public int upStartBj2(JpJejakVO params);
	public int upStartBj3(JpJejakVO params);
	public int upStartBj4(JpJejakVO params);
	public int inStartBj1(JpJejakVO params);
	public int inStartBj2(JpJejakVO params);
	public int inStartBj3(JpJejakVO params);
	public int inStartBj4(JpJejakVO params);
	public int inStartBj5(JpJejakVO params);
	public int inStartBj6(JpJejakVO params);
	public int inStartBj7(JpJejakVO params);
	public int inStartBj8(JpJejakVO params);
	public int inStartBj9(JpJejakVO params);
	public int inStartBj10(JpJejakVO params);
	public int inStartBj11(JpJejakVO params);
	public int inStartBj12(JpJejakVO params);
	public int inStartBj13(JpJejakVO params);
	public int inStartBj14(JpJejakVO params);
	public int inStartBj15(JpJejakVO params);
